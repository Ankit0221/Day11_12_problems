...
public class Day11_12_1_Stock {
	...
	public Day11_12_1_Stock(String stockName, int sharePrice, int shareQuantity, double totalSharePrice,
			int accountBalance) {
	...
	public Day11_12_1_Stock() {

	}

	public Day11_12_1_Stock(String stockName, double sharePrice, int shareQuantity, double totalSharePrice,
