...
public class Day11_12_1_Account {
    
    ArrayList<Day11_12_1_Stock> stockAccount = new ArrayList<>();
    Scanner sc = new Scanner(System.in);
    
    Day11_12_1_Stock data = new Day11_12_1_Stock();
    ...
    public void buyStock() {
        ...
        if (totalSharePrice <= data.getAccountBalance()) {
        	Day11_12_1_Stock stockData = new Day11_12_1_Stock(stockName, sharePrice, shareQuantity, totalSharePrice, remaningBalance);
    ...
    public void sellStock() {
        if (stockAccount.size() == 0) {
            ...
            for (int i = 0; i < stockAccount.size(); i++) {
            	Day11_12_1_Stock stockdata = stockAccount.get(i);
